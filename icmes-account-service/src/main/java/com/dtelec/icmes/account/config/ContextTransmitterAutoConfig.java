...
import com.dtelec.icmes.account.controller.context.UserInfo;
import com.dtelec.icmes.account.controller.context.UserInfoContext;
    ...
    public void apply(RequestTemplate requestTemplate) {
        ...
        if (user != null) {
            try {
                ...
                requestTemplate.header(UserInfoContext.KEY_USERINFO_HTTP_HEADER, 
